...
exports.prefixDate = exports.getMessages = exports.getComments = void 0;
const messages = [{
  id: 1,
  user: "James Doe",
...
getMessageBtn.addEventListener("click", async () => {
  ...
  // Hide the spinner
  try {
    const message = await (0, _api.getMessages)();
    const updatedMessage = await (0, _api.prefixDate)(message);
    const comments = await (0, _api.getComments)();
    (0, _utils.renderContent)(updatedMessage, comments, messagesContainer);
  } catch (error) {
