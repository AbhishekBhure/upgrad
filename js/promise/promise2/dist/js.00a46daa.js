...
getMessageBtn.addEventListener("click", () => {
  ...
  //Promise.allSettled()
  Promise.allSettled([(0, _api.getMessages)(), (0, _api.getComments)()]).then(res => {
    ...
    value: comments
  }]) => (0, _utils.renderContent)(messages, comments, messagesContainer)).catch(err => errorEl.innerText = `Error: ${err}`).finally(() => spinner.style.display = "none");
});
